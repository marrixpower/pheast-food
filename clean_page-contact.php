...
?>
  ...
  <main style="background-color: #000000; color: #ffffff;">
    <!-- HERO SECTION -->
    <section class="hero-section" style="min-height: 420px; white-space: normal !important;">
      <div class="hero-backdrop">
        <img src="<?php echo esc_url($hero_bg); ?>" alt="Venue Exterior">
        <div class="overlay"></div>
      </div>
      <div class="hero-content" style="max-width: 900px; width: 100%; padding: 60px 20px; box-sizing: border-box; white-space: normal !important; word-break: break-word; overflow-wrap: break-word;">
        <h1 class="hero-title" style="font-size: clamp(2.6rem, 5.5vw, 4.5rem); margin: 0 0 15px 0; white-space: normal !important; word-break: break-word; overflow-wrap: break-word;"><?php echo esc_html($hero_title); ?></h1>
        <p class="hero-subtitle text-accent" style="font-size: 1.25rem; font-weight: 700; text-transform: uppercase; letter-spacing: 1px; color: #D41F3C !important; margin-bottom: 8px; animation-delay: 0.4s; white-space: normal !important; word-break: break-word;"><?php echo esc_html($hero_sub_red); ?></p>
        <p class="hero-subtitle" style="font-size: 1.08rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; line-height: 1.45; max-width: 680px; width: 100%; margin: 0 auto; color: #ffffff; animation-delay: 0.7s; white-space: normal !important; word-break: break-word; overflow-wrap: break-word; box-sizing: border-box;"><?php echo esc_html($hero_subtitle); ?></p>
      </div>
